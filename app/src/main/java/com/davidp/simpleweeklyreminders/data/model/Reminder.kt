...
/** The moment this reminder became archived (day after endDate), or null if it isn't archived. */
fun Reminder.archivedSince(): LocalDateTime? = endDate?.plusDays(1)?.atStartOfDay()
